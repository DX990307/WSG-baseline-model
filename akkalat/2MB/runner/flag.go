...
var gmmuPTCLThresholdLow = flag.Int("gmmu-ptcl-threshold-low", -4,
	"The low threshold of the recent coalescing score for switching the GMMU L2 TLB back to PTE mode.")
var gmmuPTCLThresholdHigh = flag.Int("gmmu-ptcl-threshold-high", 4,
	"The high threshold of the recent coalescing score for switching the GMMU L2 TLB into PTCL mode.")
